package com.example.dockerexercise.controller;

import com.example.dockerexercise.Movie;
import com.example.dockerexercise.repository.MovieRepository;
...
public class MovieController {
    ...
    @PatchMapping("/{id}")
    public int partiallyUppdate(@PathVariable("id") int id, @RequestBody Movie updatedMovie) {
        Movie movie = movieRepository.getById(id);
